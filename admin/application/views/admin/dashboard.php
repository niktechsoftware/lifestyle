			                            ...
			                            <div class="panel info-box panel-white">
			                                <div class="panel-body">
			                                    <div class="info-box-stats">
			                                        <p class="counter">
			                                            	<i class="fa fa-inr"></i>
			                                            	 <span class="info-box-title"> Contact.</span>
			                                     <?php $ccode =$this->session->userdata("client_code");  
			                                     $getrow= $this->dashboardmodel->getdata("contactus",$ccode);
			                                ...
			                                <div class="panel-body">
			                                    <div class="info-box-stats">
			                                        <p>
			                                        	<i class="fa fa-inr"></i>
			                                        	<span class="counter">
			                                              	 <span class="info-box-title"> Gallery.</span>
			                                     <?php   
			                                         $getrow= $this->dashboardmodel->getdata("gallery",$ccode);
			                                        	echo $getrow->num_rows();
			                                        	?>
			                                        	</span>
			                                        </p>
			                                ...
			                                <div class="panel-body">
			                                    <div class="info-box-stats">
			                                        <p>
			                                        	<i class="fa fa-inr"></i>
			                                        	<span class="counter">
			                                        	     <span class="info-box-title">Notice Board</span>
			                                        	    <?php   
			                                ...
			                                <div class="panel-body">
			                                    <div class="info-box-stats">
			                                        <p>
			                                        	<i class="fa fa-inr"></i>
			                                        	<span class="counter">
			                                        	    <span class="info-box-title">Admission</span>
			                                        	    <?php   
			                                ...
			                                <div class="panel-body">
			                                    <div class="info-box-stats">
			                                        <p class="counter">
			                                        	...
			                                        	?>
			                                        	<?php   
			                                         $getrow= $this->dashboardmodel->getdata("employee_info",$ccode);
			                                        	echo $getrow->num_rows();
			                                        	?>
			                                        </p>
			                            ...
			                            <div class="panel info-box panel-white">
			                                <div class="panel-body">
			                                    <div class="info-box-stats">
			                                        ...
			                                        <span class="info-box-title">Letest News</span>
			                                        	<?php   
			                            ...
			                            <div class="panel info-box panel-white">
			                                <div class="panel-body">
			                                    <div class="info-box-stats">
			                                        ...
			                                        <span class="info-box-title">Upload Resume</span>
			                                        <?php   
