...
<body>
	<div id="printcontent">
			...
			<table style="width: 100%">
				<tr>
					<td width="10%" style="border: none;">
						<img src="<?php echo base_url();?>assets/images/favicon.png" alt="" width="100" />
					</td>
					<td style="border: none;">
						<h1 align="center" style="text-transform:uppercase;"><?php echo $this->session->userdata("institute_name");?></h1>
				        <h3 align="center">
							<?php echo $this->session->userdata("address_1").", ".$this->session->userdata("address_2").", ".$this->session->userdata("state").", ".$this->session->userdata("pin");?>
				        </h3>
				        <br />
				       <hr />
				        <h3 align="center">
							Registration Form Slip (Office Copy)
				        </h3>
				        <br />
					</td>
				</tr>
			 ...
			 <?php  $this->db->where("invoice_no",$this->uri->segment(3));
        	...
        	<div style="display:inline-block;">
        	 ...
        	 <table style="width: 100%;border:none;">
                    ...
                    <tr>
                     ...
                     <tr>
                    	<td style="border:none;">
                    		<?php echo '<strong>Mother Name. :</strong>'.strtoupper($rowb->m_name); ?>
                        </td>
                    </tr>
                    <tr>
                    	<td style="border:none;">
		...
		<table id="items" style="width: 100%;border:1px solid black;">
		  ...
		  <td><center>Reg. Form&nbsp;&nbsp;class -&nbsp;&nbsp;<?php echo $rowb->class; ?>&nbsp;&nbsp;</center></td>
		     <td><center><?php echo $rowb->f_fees; ?></center></td>
		  </tr>
			...
			<table style="width: 100%">
				<tr>
					...
					<td style="border: none;">
				       ...
				       <hr />
				        <h3 align="center">
							Registration Form Slip (Student Copy)
				        </h3>
				        <br />
					</td>
				</tr>
	...
	<div class="invoice-buttons">
        	...
        	<button class="btn btn-default margin-right" type="button" onclick="window.history.back();" >
        	<i class="fa fa-print padding-right-sm"></i> Back
        </button>
