                   ...
                   <div class="product-box">
                        <div class="product-imgbox" style="width:300;">
                            <div class="product-front">
                               <img src="<?php echo base_url()?>admin/assets/images/client_gallery/2/product/<?php echo $row->file1; ?>" class="img-fluid zoom" alt="product" style="height:250;width:300;">
                            </div>
                            <div class="product-back">
                               <img src="<?php echo base_url()?>admin/assets/images/client_gallery/2/product/<?php echo $row->file2; ?>" class="img-fluid zoom" alt="product" style="height:250;width:300;">
                            </div>
