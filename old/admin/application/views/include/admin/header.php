        ...
        <main class="page-content content-wrap">
            <div class="navbar">
                <div class="navbar-inner container">
                    ...
                    <div class="logo-box">
                        <a href="index.html" class="logo-text"><span><?php echo $this->session->userdata("institute_name");?></span></a>
                    </div><!-- Logo Box -->
                        ...
                        <div class="top-menu">
                            <ul class="nav navbar-nav navbar-left">
                                ...
                                <li class="dropdown">
                                  ...
                                  <li>
                                        <a href="javascript:void(0);" class="waves-effect waves-button waves-classic sidebar-toggle"><i class="fa fa-mobile"></i>
                                    Helpline Numbers - <strong> 8765414502 , 8765017757 , 9454012026 .</strong></a>
                                      </li>
                            </ul>
